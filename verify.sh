...
PYTHONPYCACHEPREFIX="$verify_cache" /usr/bin/python3 -m py_compile Support/deepseek_responses_proxy.py Support/credential_profiles.py Support/install_config.py Support/claude-provider Tests/ProxyTests.py Tests/ClaudeProviderTests.py Tests/CredentialProfileTests.py Tests/mock_anthropic_server.py
python3 Tests/ProxyTests.py
python3 Tests/ClaudeProviderTests.py
python3 Tests/CredentialProfileTests.py
